...
LOCAL_PATH := $(JNI_PATH)/CPP/

include $(CLEAR_VARS)

LOCAL_C_INCLUDES := $(LOCAL_PATH)/include_windows $(LOCAL_PATH)/myWindows $(LOCAL_PATH)/../C

LOCAL_MODULE := my7zip
LOCAL_CFLAGS := -D__linux__ -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DNDEBUG -D_REENTRANT -DENV_UNIX  -DBREAK_HANDLER -DUNICODE -D_UNICODE -fexceptions
LOCAL_SRC_FILES := \
